...
public:
    ...
    // Methos to remove minimum element (or root ) from min heap
    int extractMin()
    {
        if (heap_size <= 0)
        {
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            cout << "Enter the value that has to be inserted in the heap " << endl;
            cin >> val;
            obj.insertkey(val);
            cout<<endl;
        ...
        case 2:
            ...
            cout << "Enter the value to search in heap:" << endl;
            cin >> val;
            obj.linerSearch(val);
            break;
        case 3:
            cout << "DELETE OPERATION-" << endl;
            cout<<"Enter the index that has to be DELETED!"<<endl;
            obj.deleteKey(val);
            break;
        case 4 :
        ...
        case 5:
            ...
            break;
        case 6:
            cout << "PRINT ARRAY :" << obj.printArray() << endl;
            break;
            case 7:
